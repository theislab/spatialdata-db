...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_FFPE_Mouse_TMA_3x3_2mm_Brain_Rep2",
    counts_file=str(path_read / "CytAssist_FFPE_Mouse_TMA_3x3_2mm_Brain_Rep2_filtered_feature_bc_matrix.h5"),
