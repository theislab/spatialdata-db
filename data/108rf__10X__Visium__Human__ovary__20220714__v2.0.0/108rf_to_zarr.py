...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_11mm_FFPE_Human_Ovarian_Carcinoma",
    counts_file=str(path_read / "CytAssist_11mm_FFPE_Human_Ovarian_Carcinoma_filtered_feature_bc_matrix.h5"),
