...
sdata = visium(
    path=str(path_read),
    dataset_id="Targeted_Visium_Human_ColorectalCancer_GeneSignature",
    counts_file=str(path_read / "Targeted_Visium_Human_ColorectalCancer_GeneSignature_filtered_feature_bc_matrix.h5"),
