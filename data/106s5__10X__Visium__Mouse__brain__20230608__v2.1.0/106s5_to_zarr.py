...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_Fixed_Frozen_Sagittal_Mouse_Brain",
    counts_file=str(path_read / "CytAssist_Fixed_Frozen_Sagittal_Mouse_Brain_filtered_feature_bc_matrix.h5"),
