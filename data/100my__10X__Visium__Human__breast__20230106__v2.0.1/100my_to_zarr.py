...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_Fresh_Frozen_Human_Breast_Cancer",
    counts_file=str(path_read / "CytAssist_Fresh_Frozen_Human_Breast_Cancer_filtered_feature_bc_matrix.h5"),
