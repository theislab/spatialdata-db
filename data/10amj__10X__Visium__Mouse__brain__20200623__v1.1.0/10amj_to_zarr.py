...
sdata = visium(
    path=str(path_read),
    dataset_id="V1_Mouse_Brain_Sagittal_Anterior_Section_2",
    counts_file=str(path_read / "V1_Mouse_Brain_Sagittal_Anterior_Section_2_filtered_feature_bc_matrix.h5"),
