...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_FFPE_Protein_Expression_Human_Glioblastoma",
    counts_file=str(path_read / "CytAssist_FFPE_Protein_Expression_Human_Glioblastoma_filtered_feature_bc_matrix.h5"),
