...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_FFPE_Mouse_TMA_3x3_2mm_Brain_Rep4",
    counts_file=str(path_read / "CytAssist_FFPE_Mouse_TMA_3x3_2mm_Brain_Rep4_filtered_feature_bc_matrix.h5"),
