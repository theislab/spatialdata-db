...
sdata = visium(
    path=str(path_read),
    dataset_id="Targeted_Visium_Human_OvarianCancer_Immunology",
    counts_file=str(path_read / "Targeted_Visium_Human_OvarianCancer_Immunology_filtered_feature_bc_matrix.h5"),
