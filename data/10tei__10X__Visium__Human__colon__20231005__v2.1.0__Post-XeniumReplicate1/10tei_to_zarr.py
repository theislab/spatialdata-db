...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_FFPE_Human_Colon_Post_Xenium_Rep1",
    counts_file=str(path_read / "CytAssist_FFPE_Human_Colon_Post_Xenium_Rep1_filtered_feature_bc_matrix.h5"),
