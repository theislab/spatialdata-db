...
sdata = visium(
    path=str(path_read),
    dataset_id="Aggregate_CytAssist_FFPE_TMA_3x3_2mm",
    counts_file=str(path_read / "Aggregate_CytAssist_FFPE_TMA_3x3_2mm_filtered_feature_bc_matrix.h5"),
    fullres_image_file=str(path_read / "spatial" /"tissue_hires_image.png"),
    tissue_positions_file=str(path_read / "spatial" / "Aggregate_CytAssist_FFPE_TMA_3x3_2mm_aggr_tissue_positions.csv"),
