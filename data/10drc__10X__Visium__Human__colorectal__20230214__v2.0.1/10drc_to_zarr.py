...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_11mm_FFPE_Human_Colorectal_Cancer",
    counts_file=str(path_read / "CytAssist_11mm_FFPE_Human_Colorectal_Cancer_filtered_feature_bc_matrix.h5"),
