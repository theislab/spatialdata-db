...
sdata = visium(
    path=str(path_read),
    dataset_id="Visium_FFPE_Human_Prostate_Acinar_Cell_Carcinoma",
    counts_file=str(path_read / "Visium_FFPE_Human_Prostate_Acinar_Cell_Carcinoma_filtered_feature_bc_matrix.h5"),
