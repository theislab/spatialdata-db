...
sdata = visium(
    path=str(path_read),
    dataset_id="Aggregate_Visium_Mouse_Brain_Sagittal",
    counts_file=str(path_read / "Aggregate_Visium_Mouse_Brain_Sagittal_filtered_feature_bc_matrix.h5"),
    fullres_image_file=str(path_read / "spatial" /"tissue_hires_image.png"),
    tissue_positions_file=str(path_read / "spatial" / "Aggregate_Visium_Mouse_Brain_Sagittal_aggr_tissue_positions.csv"),
