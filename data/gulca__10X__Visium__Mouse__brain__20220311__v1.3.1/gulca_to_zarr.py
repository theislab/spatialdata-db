...
sdata = visium(
    path=str(path_read),
    dataset_id="VisiumFFPE_Mouse_Brain_Alzheimers_AppNote",
    counts_file=str(path_read / "VisiumFFPE_Mouse_Brain_Alzheimers_AppNote_filtered_feature_bc_matrix.h5"),
    fullres_image_file=str(path_read / "spatial" /"tissue_hires_image.png"),
    tissue_positions_file=str(path_read / "spatial" / "VisiumFFPE_Mouse_Brain_Alzheimers_AppNote_aggr_tissue_positions_list.csv"),
