...
sdata = visium(
    path=str(path_read),
    dataset_id="CytAssist_FFPE_Protein_Expression_Human_Tonsil_AddOns",
    counts_file=str(path_read / "CytAssist_FFPE_Protein_Expression_Human_Tonsil_AddOns_filtered_feature_bc_matrix.h5"),
